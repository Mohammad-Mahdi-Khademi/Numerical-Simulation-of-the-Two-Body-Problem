...
%main functions
fFx1 = @(t,x1,Vx1,y1,Vy1,x2,Vx2,y2,Vy2) (G*m2*(x2-x1))/(((x1-x2)^2+(y1-y2)^2));
fFy1 = @(t,x1,Vx1,y1,Vy1,x2,Vx2,y2,Vy2) (G*m2*(y2-y1))/(((x1-x2)^2+(y1-y2)^2));

fFx2 = @(t,x1,Vx1,y1,Vy1,x2,Vx2,y2,Vy2) (G*m1*(x1-x2))/(((x1-x2)^2+(y1-y2)^2));
fFy2 = @(t,x1,Vx1,y1,Vy1,x2,Vx2,y2,Vy2) (G*m1*(y1-y2))/(((x1-x2)^2+(y1-y2)^2));
